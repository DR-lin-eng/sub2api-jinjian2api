...
// These narrow embeddings keep unrelated gateway tests focused on the methods
// they exercise while the production repository interfaces continue to evolve.
