...
func TestContainsModelFamilyRequiresSuffixBoundary(t *testing.T) {
	assert.True(t, containsModelFamily("claude-opus-5", "claude-opus-5"))
	assert.True(t, containsModelFamily("us.anthropic.claude-opus-5-v1", "claude-opus-5"))
	assert.True(t, containsModelFamily("claude-opus-5@20260725", "claude-opus-5"))
	assert.False(t, containsModelFamily("claude-opus-50", "claude-opus-5"))
	assert.False(t, containsModelFamily("claude-opus-5x", "claude-opus-5"))
}
