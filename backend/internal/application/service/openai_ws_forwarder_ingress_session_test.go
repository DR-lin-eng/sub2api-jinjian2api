...
func TestOpenAIWSDownstreamWriteContext_CancellationOwnership(t *testing.T) {
	t.Run("ordinary control cancellation propagates without lifecycle hook", func(t *testing.T) {
	...
	t.Run("lease loss keeps current write alive until client lifecycle ends", func(t *testing.T) {
...
func TestOpenAIGatewayService_ProxyResponsesWebSocketFromClient_LeaseLossSendsTerminalThenRetryClose(t *testing.T) {
	gin.SetMode(gin.TestMode)
