...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/DR-lin-eng/sub2api-jinjian2api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/DR-lin-eng/sub2api-jinjian2api/blob/main/docs/legal/admin-compliance.en.md"
