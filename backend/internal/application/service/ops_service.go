...
func (s *OpsService) RefreshRuntimeSettings(ctx context.Context) error {
	...
	if advanced.DataRetention.UserRequestLogRetentionDays < 1 || advanced.DataRetention.UserRequestLogRetentionDays > 3650 {
		advanced.DataRetention.UserRequestLogRetentionDays = advancedDefaults.DataRetention.UserRequestLogRetentionDays
	}
