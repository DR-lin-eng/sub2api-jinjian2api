...
// handleOpenAIWSPreOutputFailure turns a retryable WS failure into the same
// account-switch contract used by HTTP/SSE. It must be called before any
// semantic bytes are written downstream.
