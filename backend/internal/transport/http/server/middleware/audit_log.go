...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/settings/admin-api-keys/:id/rotate":   "admin.admin_api_keys.rotate",
	"DELETE /api/v1/admin/settings/admin-api-keys/:id":        "admin.admin_api_keys.revoke",
