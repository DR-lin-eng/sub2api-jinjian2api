...
func TestImageDiagnosticLogValueIsBounded(t *testing.T) {
	longValue := strings.Repeat("x", imageDiagnosticLogMaxBytes+32)
	require.Equal(t, strings.Repeat("x", imageDiagnosticLogMaxBytes), imageDiagnosticLogValue(longValue))
	require.Equal(t, "1536x1024", imageDiagnosticLogValue("1536x1024"))
}
