...
func TestPromptAuditGatePrecedesAccountBillingAndUpstreamSideEffects(t *testing.T) {
	tests := []promptAuditOrderCase{
		{file: "gateway_handler_messages.go", function: "Messages", auditToken: "checkSecurityAudit"},
		...
		{file: "openai_gateway_responses.go", function: "Responses", auditToken: "checkSecurityAudit"},
		{file: "openai_gateway_messages.go", function: "Messages", auditToken: "checkSecurityAudit"},
