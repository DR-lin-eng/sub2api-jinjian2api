...
INSERT INTO content_moderation_logs (
    ...
    email_sent, queue_delay_ms, matched_keyword
) VALUES (
    $1, $2, $3, $4, $5, $6, $7,
    ...
    $21, $22, $23
		...
		log.EmailSent, nullableIntPtr(log.QueueDelayMS), log.MatchedKeyword,
...
SELECT
    ...
    l.email_sent, l.queue_delay_ms, l.matched_keyword, l.created_at
FROM content_moderation_logs l `+whereSQL+`
