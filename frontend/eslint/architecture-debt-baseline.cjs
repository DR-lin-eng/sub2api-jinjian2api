...
module.exports = {
  legacyBarrelImports: {
    '@/api': [
      ...
      'src/features/admin-settings/presentation/stores/adminSettingsStore.ts',
      'src/features/admin-settings/presentation/widgets/EmailTemplateEditor.vue',
      'src/features/admin-settings/presentation/widgets/PanelRateLimitSettingsCard.vue',
    ...
    '@/api/admin': [
      ...
      'src/features/admin-accounts/presentation/composables/useAccountOAuth.ts',
      'src/features/admin-accounts/presentation/composables/useAntigravityOAuth.ts',
      'src/features/admin-accounts/presentation/composables/useGeminiOAuth.ts',
      'src/features/admin-accounts/presentation/composables/useGrokOAuth.ts',
      'src/features/admin-accounts/presentation/composables/useOpenAIOAuth.ts',
      'src/features/admin-accounts/presentation/widgets/AdminReAuthAccountDialog.vue',
      ...
      'src/features/admin-accounts/presentation/widgets/ImportDataDialog.vue',
      'src/features/admin-accounts/presentation/widgets/ReAuthAccountDialog.vue',
      'src/features/admin-accounts/presentation/widgets/SyncFromCrsDialog.vue',
      'src/features/admin-audit/presentation/pages/AuditLogPage.vue',
      ...
      'src/features/admin-settings/presentation/widgets/ErrorPassthroughRulesDialog.vue',
      'src/features/admin-settings/presentation/widgets/OpenAIFastPolicyUserSelector.vue',
      'src/features/admin-settings/presentation/widgets/TLSFingerprintProfilesDialog.vue',
    ...
    '@/stores': [
      ...
      'src/features/admin-settings/presentation/widgets/AdminComplianceDialog.vue',
      'src/features/admin-settings/presentation/widgets/EmailTemplateEditor.vue',
      'src/features/admin-settings/presentation/widgets/PanelRateLimitSettingsCard.vue',
