export default {
    ...
    riskControl: {
	  ...
	  modeObserveDesc: 'Requests pass through while the latest input is queued for async review; hits are recorded and administrators are notified when configured.',
      modeOff: 'Off',
      modeOffDesc: 'Content moderation is disabled and no audit records are written.',
      baseUrl: 'OpenAI Base URL',
      model: 'Model',
      proxy: 'Moderation Proxy',
	  ...
	  preHashCheckHint: 'Hashes from async hits are blocked before moderation; the block is logged without sending another notice email.',
	  ...
	  emailOnHitHint: 'When enabled, every moderation hit sends a gateway risk-control notice to the current administrator email.',
