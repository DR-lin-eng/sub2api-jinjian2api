export default {
    ops: {
      ...
      settings: {
        ...
        dataRetention: 'Data Cleanup and Retention',
        userRequestLogs: 'User Request Logs',
        userRequestLogsHint: 'Raw request and billing details are cleaned after aggregation and are independent of the ops monitoring cleanup switch.',
        userRequestLogRetentionDays: 'User Request Log Retention Days',
        opsMonitoringData: 'Ops Monitoring Data',
        opsMonitoringDataHint: 'Includes error logs, alert events, system logs, and minute and hourly metrics.',
        enableOpsCleanup: 'Enable Ops Monitoring Data Cleanup',
        ...
        dashboardCards: 'Dashboard Data Panels',
        displayConcurrency: 'Show Concurrency / Queueing',
        displayConcurrencyHint: 'When disabled, real-time concurrency, queueing, and group load data are not loaded.',
        displaySwitchRateTrend: 'Show Account Switch Rate Trend',
        displaySwitchRateTrendHint: 'When disabled, the fixed five-hour account switch rate trend is not queried.',
        displayThroughputTrend: 'Show Throughput Trend',
        displayThroughputTrendHint: 'When disabled, the throughput trend aggregation is omitted from the core snapshot.',
        displayLatencyHistogram: 'Show Request Duration Histogram',
        displayLatencyHistogramHint: 'When disabled, the request duration histogram aggregation is omitted from the core snapshot.',
        displayErrorDistribution: 'Show Error Distribution',
        ...
        validation: {
          title: 'Please fix the following issues',
          userRequestLogRetentionDaysRange: 'User request log retention must be between 1 and 3650 days',
