  ...
  <AppLayout>
    <div class="mx-auto max-w-[1600px]" :class="activeTab === 'config' && draft ? 'pb-28' : 'pb-8'">
      <header class="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          <p class="text-xs font-semibold uppercase tracking-[0.16em] text-primary-600 dark:text-primary-400">{{ t('nav.promptAudit') }}</p>
...
import RuntimeOverview from '../widgets/RuntimeOverview.vue'
import EndpointPool from '../widgets/EndpointPool.vue'
import PolicyPanel from '../widgets/PolicyPanel.vue'
import EventWorkspace from '../widgets/EventWorkspace.vue'
import EventDetailDialog from '../widgets/EventDetailDialog.vue'
import FilterDeleteDialog from '../widgets/FilterDeleteDialog.vue'
import promptAuditAPI from '../../data/datasources/promptAuditDatasource'
import type {
  PromptAuditDraft,
...
import { buildUpdateRequest, cloneData, configToDraft, draftFingerprint, emptyEventFilters } from '../../domain/promptAuditViewModel'
