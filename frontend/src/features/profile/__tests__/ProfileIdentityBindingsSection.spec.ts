...
vi.mock('@/features/profile/data/datasources/profileDatasource', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/profile/data/datasources/profileDatasource')>()
  return {
    ...actual,
