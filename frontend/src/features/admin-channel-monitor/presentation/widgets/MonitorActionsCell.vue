<template>
  <div class="flex items-center gap-1">
    ...
    <button
      ...
      :disabled="duplicating || ((row.monitorMode || 'active') === 'active' && Boolean(row.apiKeyDecryptFailed))"
...
const duplicateTitle = computed(() => {
  if ((props.row.monitorMode || 'active') === 'active' && props.row.apiKeyDecryptFailed) return t('admin.channelMonitor.duplicateKeyUnavailable')
