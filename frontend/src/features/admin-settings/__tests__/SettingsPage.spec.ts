...
import SettingsPage from "@/features/admin-settings/presentation/pages/SettingsPage.vue";
...
describe("admin SettingsPage payment visible method controls", () => {
  beforeEach(() => {
...
describe("admin SettingsPage wechat connect controls", () => {
  beforeEach(() => {
    getSettings.mockReset();
    updateSettings.mockReset();
    getWebSearchEmulationConfig.mockReset();
...
describe("admin SettingsPage platform quota matrix", () => {
  beforeEach(() => {
    getSettings.mockReset();
    updateSettings.mockReset();
    getWebSearchEmulationConfig.mockReset();
