                ...
                <div class="flex min-w-0 items-center gap-3">
                  ...
                  <div class="min-w-0">
                    <p class="truncate text-sm font-semibold text-gray-900 dark:text-white">
                      {{ (doc as any).title || localText("未命名文档", "Untitled document") }}
                    </p>
                    <p class="truncate text-xs text-gray-500 dark:text-gray-400">
                      {{ loginAgreementRoutePath(doc as any, index) }}
                    </p>
                  </div>
                </div>
                <button
                    ...
                    :disabled="
                    (form.loginAgreementEnabled as boolean) &&
                    (form.loginAgreementDocuments as any[]).length <= 1
                  "
...
const props = defineProps<{ form: Record<string, any>; saving: boolean }>()
