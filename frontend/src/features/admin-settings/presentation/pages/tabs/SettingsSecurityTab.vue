  ...
  <div class="space-y-6">
    ...
    <div class="card">
      ...
      <div class="space-y-4 p-6">
        ...
        <div v-else-if="!adminApiKeyExists" class="flex items-center justify-between">
          ...
          <button type="button" @click="createAdminApiKey" :disabled="adminApiKeyOperating"
        ...
        <div v-else class="space-y-4">
          <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
              <button type="button" @click="regenerateAdminApiKey" :disabled="adminApiKeyOperating"
      ...
      <div class="space-y-5 p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
              {{ t("admin.settings.registration.enableRegistrationHint") }}</p>
          </div>
        ...
        <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
              {{ t("admin.settings.registration.emailVerificationHint") }}</p>
          </div>
        ...
        <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
          ...
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {{ t("admin.settings.registration.emailSuffixWhitelistHint") }}</p>
          ...
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t("admin.settings.registration.emailSuffixWhitelistInputHint") }}</p>
        </div>
        <!-- Promo Code -->
        <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
          <div>
    ...
    <div class="card">
      ...
      <div class="space-y-5 p-6">
        ...
        <p v-if="form.clientIpResolutionStatus.cloudflareLastSuccessAt"
    ...
    <div class="card">
      ...
      <div class="space-y-5 p-6">
        <div v-for="provider in humanVerificationProviders" :key="provider.key"
          ...
          <Toggle :model-value="form[provider.key]"
        ...
        <div v-if="form.turnstileEnabled" class="border-t border-gray-100 pt-4 dark:border-dark-700">
          <div class="grid grid-cols-1 gap-6">
            <div>
              ...
              <input v-model="form.turnstileSiteKey" type="text" class="input font-mono text-sm"
                     placeholder="0x4AAAAAAA..."/>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.turnstile.siteKeyHint") }}
                <a href="https://dash.cloudflare.com/" target="_blank" class="text-primary-600 hover:text-primary-500">{{
        ...
        <div v-if="form.recaptchaEnabled" class="border-t border-gray-100 pt-4 dark:border-dark-700">
          <div class="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              <input v-model="form.recaptcha_secret_key" type="password" class="input font-mono text-sm"
                     placeholder="6Lc..."/>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{
        ...
        <div v-if="form.capEnabled" class="border-t border-gray-100 pt-4 dark:border-dark-700">
          <div class="grid grid-cols-1 gap-6">
            <div>
              ...
              <input v-model="form.capApiEndpoint" type="url" class="input font-mono text-sm"
                     placeholder="https://cap.example.com/site-key"/>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.turnstile.capEndpointHint") }}</p>
            </div>
            <div>
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                  t("admin.settings.turnstile.secretKey")
