...
import OpsErrorDistributionChart from '../presentation/widgets/OpsErrorDistributionChart.vue'
import OpsErrorTrendChart from '../presentation/widgets/OpsErrorTrendChart.vue'
...
vi.mock('../presentation/opsFormatter', () => ({
