...
import OpsRequestDetailsDialog from '@/features/admin-ops/presentation/widgets/OpsRequestDetailsDialog.vue'
...
describe('OpsRequestDetailsDialog', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('TTFT 明细仅查询有首 Token 的成功请求并显示 TTFT 列', async () => {
    const wrapper = mount(OpsRequestDetailsDialog, {
      props: {
        modelValue: false,
        timeRange: '1h',
        preset: {
