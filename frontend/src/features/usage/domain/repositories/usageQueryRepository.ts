...
export interface UsageQueryRepository {
  ...
  query(params: UsageQueryParams & { sort_by?: string; sort_order?: 'asc' | 'desc' }, config?: { signal?: AbortSignal }): Promise<PaginatedResponse<UsageLog>>
  getStats(paramsOrPeriod?: (UsageQueryParams & { period?: string; timezone?: string }) | string, apiKeyId?: number): Promise<UsageStatsResponse>
