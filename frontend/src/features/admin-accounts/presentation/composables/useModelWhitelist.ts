...
import { adminAccountsRepository } from '@/features/admin-accounts/data/repositories/adminAccountsRepositoryImpl'
const { getAntigravityDefaultModelMapping } = adminAccountsRepository
