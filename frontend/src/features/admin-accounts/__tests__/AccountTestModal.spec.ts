...
import AccountTestDialog from '@/features/admin-accounts/presentation/widgets/AccountTestDialog.vue'
...
describe('AccountTestDialog', () => {
  ...
  it('posts compact mode for OpenAI compact probe', async () => {
    const wrapper = mount(AccountTestDialog, {
      props: {
        show: true,
