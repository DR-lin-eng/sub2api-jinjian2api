...
vi.mock('@/features/admin-accounts/data/datasources/adminAccountsQueryDatasource', () => ({
  ...
  adminAccountsQueryDatasource: { getAntigravityDefaultModelMapping: vi.fn().mockResolvedValue([]) },
}))
...
function mountModal() {
  return mount(CreateAccountDialog, {
...
describe('CreateAccountDialog OpenAI long-context billing', () => {
  beforeEach(() => {
