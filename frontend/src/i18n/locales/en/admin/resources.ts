export default {
    ...
    redeem: {
      ...
      perUserLimit: 'Up to {count} per user',
      columns: {
        code: 'Code',
        type: 'Type',
        value: 'Value',
      ...
      maxUsesHint: 'Enter 0 for no total limit',
      maxUsesPerUser: 'Per-user usage limit',
      maxUsesPerUserHint: 'Defaults to 1; enter 0 for no per-user limit',
      generating: 'Generating...',
      generate: 'Generate',
      copyAll: 'Copy All',
      copied: 'Copied!',
      download: 'Download',
      downloadPrompt: 'Download the redeem codes created in this batch? Choose a file format.',
      ...
      failedToExportGenerated: 'Failed to download newly generated codes',
