export default {
    ...
    redeem: {
      ...
      used: '已使用',
      unlimited: '不限',
      unlimitedPerUser: '每位用户不限次数',
      perUserLimit: '每位用户最多 {count} 次',
      ...
      count: '数量',
      maxUses: '总使用上限',
      maxUsesHint: '填写 0 表示总次数不限',
      maxUsesPerUser: '每位用户使用上限',
      maxUsesPerUserHint: '默认 1 次；填写 0 表示同一用户不限次数',
      generate: '生成',
      copyAll: '全部复制',
      download: '下载',
      downloadPrompt: '是否下载本次新增的兑换码列表？请选择文件格式。',
      downloadCsv: '下载 CSV',
      downloadTxt: '下载 TXT',
      downloading: '下载中...',
      ...
      failedToExportGenerated: '下载本次新增兑换码失败',
