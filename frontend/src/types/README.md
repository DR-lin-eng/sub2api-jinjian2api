...
- `common.ts`: common UI, authentication, users, announcements and public settings.
- `gateway.ts`: groups, API keys, accounts, proxies and gateway import/export contracts.
- `usage.ts`: usage, statistics, subscriptions, redeem codes and user attributes.
- `payment.ts`: payment-specific contracts.
