...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/dr-lin-eng/sub2api-jinjian2api:latest
...
SUB2API_IMAGE=ghcr.io/dr-lin-eng/sub2api-jinjian2api:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
